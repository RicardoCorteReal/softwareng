...
namespace UI_Appoinment
{
    public partial class FormAppointHome : Form
    {
        ...
        {
            theConnection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=K:\Overs Surgery(7.3)\Overs Surgery\PatientDatabase.mdf;Integrated Security=True");
            theConnection.Open();
