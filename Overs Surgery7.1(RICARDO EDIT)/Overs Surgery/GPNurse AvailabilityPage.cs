...
namespace Overs_Surgery
{
    public partial class GPNurse_AvailabilityPage : Form
    {
        ...
        private void GPNurse_AvailabilityPage_Load(object sender, EventArgs e)
        {
            ...
            conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=K:\Overs Surgery7.1\Overs Surgery\PatientDatabase.mdf;Integrated Security=True");
            conn.Open();
