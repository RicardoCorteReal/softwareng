...
namespace Overs_Surgery
{
    public partial class NewPatientRecord : Form
    {
        ...
        {
            cn = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = I:\Uni Files\2nd Year\Software Engineering\Planning Files\Program Files\Overs Surgery(4.0)\Overs Surgery\PatientDatabase.mdf; Integrated Security = True");
            cn.Open();
            ...
            Insert.Parameters.AddWithValue("@DateOfBirth", DateOfBirthTextBox.Text);
