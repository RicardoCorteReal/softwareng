...
namespace Overs_Surgery
{
    public partial class GPNurse_AvailabilityPage : Form
    {
        ...
        private void GPNurse_AvailabilityPage_Load(object sender, EventArgs e)
        {
            ...
            SearchGpQuery = new SQL_Commands();
            conn = new SqlConnection(Properties.Settings.Default.DatabaseConnection);
            conn.Open();
        ...
        { 
            conn.Open();
            Search = new SqlCommand(SearchGpQuery.SearchGp(RoleSearchBox.Text, YesAndNoComboBox.Text, DateTextBox.Text), conn);
        ...
        {
            conn.Open();
            SqlCommand Search2 = new SqlCommand(SearchGpQuery.SearchGp(RoleSearchBox.Text, YesAndNoComboBox.Text, DateTextBox.Text), conn);
        ...
        {
            conn.Open();
            SqlCommand search4 = new SqlCommand(SearchGpQuery.SearchGp(RoleSearchBox.Text, YesAndNoComboBox.Text, DateTextBox.Text), conn);
